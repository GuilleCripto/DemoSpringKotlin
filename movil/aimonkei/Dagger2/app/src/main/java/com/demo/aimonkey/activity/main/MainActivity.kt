...
import com.demo.aimonkey.Factory.ViewModelFactory
import com.soumyajit.daggermultibindingmvvmsample.R
import com.demo.aimonkey.SingleDataModel
import com.demo.aimonkey.activity.showToast
import com.demo.aimonkey.recyclerview.UsersAdapter
...
class MainActivity : DaggerAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /* GlobalScope.launch(Dispatchers.Main) {
            val result = withContext(Dispatchers.IO) { DataProvider.doHeaviTask()}
            prinr
        }*/
